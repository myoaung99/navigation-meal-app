...
function CategoriesGridScreen({ navigation }) {
  ...
  let screenPaddingHorizontal = 16;
  if (DeviceHeight < 400 && DeviceWidth > 400) {
    screenPaddingHorizontal = 50;
  }
  ...
  return (
    <View
      style={[styles.screen, { paddingHorizontal: screenPaddingHorizontal }]}
    >
      <FlatList
